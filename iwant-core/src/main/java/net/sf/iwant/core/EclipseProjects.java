...
public class EclipseProjects implements Content {
	...
	private void buildXml(EclipseProject project, File destination)
		...
		b.append("		<property name=\"wishdir\" value=\"iwant\" />\n");
		b.append("	</target>\n");
		b.append("\n");
		b.append("	<target name=\"cached\" depends=\"wishdir\">\n");
		b.append("		<property name=\"cached\" value=\"${wishdir}/cached\" />\n");
		b.append("	</target>\n");
		b.append("\n");
		b.append("	<target name=\"my-cached\" depends=\"cached\">\n");
		b.append("		<property name=\"my-cached\" value=\"${cached}/build-xml\" />\n");
		...
		b.append("		<property name=\"wsdef-classes\" value=\"${my-cached}/wsdef-classes\" />\n");
		...
		b.append("		<sequential>\n");
		b.append("			<java classname=\"net.sf.iwant.core.WorkspaceBuilder\" fork=\"true\" outputproperty=\"iwant-out\" failonerror=\"true\">\n");
		b.append("				<arg value=\"${wsdef-classname}\" />\n");
		b.append("				<arg value=\"${basedir}\" />\n");
